 ...
 * |------+------+------+------+------+------+------| |------+------+------+------+------+------+------|
 * | LCTL | LALT | LGUI | LGUI |LOWER | SPC  | LSFT | |      | SPC  |RAISE | LEFT | DOWN |  UP  | RGHT |
 * `------------------------------------------------' `------------------------------------------------'
...
[_QWERTY] = KEYMAP( \
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_LGUI, LOWER,   KC_SPC, KC_LSFT,    _______,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
    ),
 ...
 * |------+------+------+------+------+------+------. ,------+------+------+------+------+------+------|
 * |      |  F7  |  F8  |  F9  | F10  | F11  | LPRN | | RPRN | F12  |      |      | HOME | END  |      |
 * |------+------+------+------+------+------+------| |------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      | |      |      |      | MNXT | VOLD | VOLU | MPLY |
 * `------------------------------------------------' `------------------------------------------------'
 *                                                                              generated by [keymapviz] */
 ...
 * |      |RESET |RGBRST|      |      |      |               |      |      |      |      |      | DEL  |
 * |------+------+------+------+------+------|               |------+------+------+------+------+------|
 * |      |      |      |AU_ON |AU_OFF|AG_NOR|               |AG_SWA|QWERTY|      |      |      |      |
 * |------+------+------+------+------+------+------. ,------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      | |      |      |      |RGB_TO|RGB_HU|RGB_SA|RGB_VA|
 * |------+------+------+------+------+------+------| |------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      | |      |      |      |RGB_SM|RGB_HU|RGB_SA|RGB_VA|
 * `------------------------------------------------' `------------------------------------------------'
 *                                                                              generated by [keymapviz] */
[_ADJUST] =  KEYMAP( \

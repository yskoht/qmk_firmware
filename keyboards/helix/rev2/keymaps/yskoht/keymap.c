 ...
 * |------+------+------+------+------+------+------| |------+------+------+------+------+------+------|
 * | LCTL | LGUI | LALT | LALT |LOWER | SPC  |      | |      | SPC  |RAISE | LEFT | DOWN |  UP  | RGHT |
 * `------------------------------------------------' `------------------------------------------------'
...
[_QWERTY] = KEYMAP( \
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_LALT, LOWER,   KC_SPC, _______,    _______,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
    ),

...
/* .---------------------------------------------. .---------------------------------------------.
 * |  ESC  |  1  |  2  |  3  |  4  |  5  |       | !  PSc  |  6  |  7  |  8  |  9  |  0  | BSPC  |
 * !-------+-----+-----+-----+-----+-------------! !-------+-----+-----+-----+-----+-----+-------!
 * |  TAB  |  Q  |  W  |  E  |  R  |  T  | CtrlG | ! PASTE |  Y  |  U  |  I  |  O  |  P  | BSPC  |
 * !-------+-----+-----+-----x-----x-----!       ! !       !-----x-----x-----+-----+-----+-------!
 * | LCTRL |  A  |  S  |  D  |  F  |  G  |-------! !-------!  H  |  J  |  K  |  L  |SCLN | QUOT  |
 * !-------+-----+-----+-----x-----x-----!   N   ! !   B   !-----x-----x-----+-----+-----+-------!
 * | LSFT  |  Z  |  X  |  C  |  V  |  B  |       | !       |  N  |  M  |COMM | DOT |SLSH |ET/SFT |
 * '-------+-----+-----+-----+-----+-------------' '-------------+-----+-----+-----+-----+-------'
 *  |LCTRL |LGUI |LALT |LALT |LOWER|                             !RAISE|LEFT |DOWN | UP  |RIGHT |
 *  '------------------------------'                             '------------------------------'
 *                               .---------------. .---------------.
 *                               | COPY  |SFT-SPC| ! LEFT  | RIGHT |
 *                       .-------+-------+-------! !-------+-------+-------.
 *                       ! LSFT  !  SPC  |ALT-TAB| !  UP   |  ENT  !  SPC  !
 *                       !       !       !-------! !-------!       !       !
 *                       |       |       | LALT  | ! DOWN  |       |       |
 *                       '-----------------------' '-----------------------'
 */
